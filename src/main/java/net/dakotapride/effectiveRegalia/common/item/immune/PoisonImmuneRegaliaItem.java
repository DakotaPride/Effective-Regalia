...
public class PoisonImmuneRegaliaItem extends RegaliaItem {
    public PoisonImmuneRegaliaItem(Settings settings) {
        super(settings);
    }
    ...
    public static class GoldenPoisonImmuneRegalia extends PoisonImmuneRegaliaItem {
        public GoldenPoisonImmuneRegalia(Settings settings) {
            super(settings);
        }
    ...
    public static class NetheritePlatedPoisonImmuneRegalia extends PoisonImmuneRegaliaItem {
        public NetheritePlatedPoisonImmuneRegalia(Settings settings) {
            super(settings);
        }
